...
(function (window) {
    ...
    let getHtmlFormInputSnippet = (count) => `
        <div id="inputItem${count}" class="col-12 row mt-3">
            ...
            <div class="col-1">
                <button onclick="$dc.addItem()" class="btn pt-0 float-end">
                    <img width="35" src="../images/plus-circle.svg">
                </button>
            </div>
        </div>
    `;
    ...
    $(document).ready(function() {
        ...
        dc.addItem = () => {
            ...
            $(`#inputItem${count} :nth-child(6)`).html(
                `<button onclick="$dc.deleteItem(${count})" class="btn pt-0 float-end">
                    <img width="35" src="../images/minus-circle.svg">
                </button>`
            );
            count++;
